...
func TestControlPlaneConfigDeprecatedSettingReported(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			config:   `{"defaults":{"restrictOutbound":true},"environment":"kubernetes","mode":"zone","experimental":{"autoReachableServices":true,"deltaXds":true,"sidecarContainers":true,"inboundTagsDisabled":true,"kdsEventBasedWatchdog":{"enabled":true}},"runtime":{"kubernetes":{"injector":{"unifiedResourceNamingEnabled":true}}}}`,
		...
		},
		{
			...
			config:   `{"defaults":{"restrictOutbound":true},"environment":"kubernetes","mode":"zone","experimental":{"deltaXds":true,"sidecarContainers":true,"inboundTagsDisabled":true,"kdsEventBasedWatchdog":{"enabled":true}},"runtime":{"kubernetes":{"injector":{"unifiedResourceNamingEnabled":true,"ebpf":{"enabled":true}}}}}`,
		...
		},
		{
			...
			config:   `{"defaults":{"restrictOutbound":true},"environment":"kubernetes","mode":"zone","experimental":{"deltaXds":true,"sidecarContainers":true,"inboundTagsDisabled":true,"kdsEventBasedWatchdog":{"enabled":true}},"runtime":{"kubernetes":{"injector":{"unifiedResourceNamingEnabled":false}}}}`,
		...
		{
			name:     "delta xds off",
			config:   `{"defaults":{"restrictOutbound":true},"environment":"kubernetes","mode":"zone","experimental":{"deltaXds":false,"sidecarContainers":true,"inboundTagsDisabled":true,"kdsEventBasedWatchdog":{"enabled":true}},"runtime":{"kubernetes":{"injector":{"unifiedResourceNamingEnabled":true}}}}`,
		...
		},
		{
			...
			config:   `{"defaults":{"restrictOutbound":true},"environment":"kubernetes","mode":"zone","experimental":{"deltaXds":true,"sidecarContainers":true,"inboundTagsDisabled":true,"kdsEventBasedWatchdog":{"enabled":false}},"runtime":{"kubernetes":{"injector":{"unifiedResourceNamingEnabled":true}}}}`,
		...
		},
		{
			...
			config:   `{"defaults":{"restrictOutbound":true},"environment":"kubernetes","mode":"zone","experimental":{"deltaXds":true,"sidecarContainers":false,"inboundTagsDisabled":true,"kdsEventBasedWatchdog":{"enabled":true}},"runtime":{"kubernetes":{"injector":{"unifiedResourceNamingEnabled":true}}}}`,
